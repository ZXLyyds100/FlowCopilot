          ...
          <Space direction="vertical" className="w-full" size="middle">
            ...
            <div>
              ...
              <TextArea
                ...
                onChange={(event) => onTemplateEditorChange(event.target.value)}
                className="font-mono"
              />
              <Space className="mt-3">
                <Button type="primary" loading={templateSaving} onClick={onSaveTemplate}>
                  保存模板
                </Button>
                <Button onClick={onResetTemplateEditor}>重置</Button>
              </Space>
            </div>
          </Space>
        </div>
