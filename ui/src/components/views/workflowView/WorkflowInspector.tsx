...
export default function WorkflowInspector({
  ...
  return (
    <div className="flex h-full flex-col gap-6">
      ...
      <section>
        <Typography.Title level={5}>待审批事项</Typography.Title>
        <List
      ...
      <section>
        <Typography.Title level={5}>最近工作流</Typography.Title>
        <List
          ...
          renderItem={(workflow) => (
            <List.Item>
              <button
                ...
                className="w-full rounded-xl px-2 py-1 text-left transition hover:bg-slate-50"
              >
                {workflow.title}
              </button>
            </List.Item>
